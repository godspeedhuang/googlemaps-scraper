...
class GoogleMapsScraper:
    ...
    def sort_by(self, url, ind):
        ...
        while not clicked and tries < MAX_RETRY:
            try:
                ...
                menu_bt = wait.until(EC.element_to_be_clickable(
                    (By.XPATH, '//*[@id="pane"]/div/div[1]/div/div/div[2]/div[1]/div[1]/div[2]/div/div[1]/span[1]/span/span[1]/span[2]/span[1]/button')))
                menu_bt.click()
        ...
        recent_rating_bt = self.driver.find_elements_by_xpath(
            '//*[@id="pane"]/div/div[1]/div/div/div[2]/div[7]/div[2]/button/span/span')[0]
        recent_rating_bt.click()
        recent_rating_bt_select = self.driver.find_elements_by_xpath(
            '//*[@id="action-menu"]/ul/li')[ind]
        recent_rating_bt_select.click()
    ...
    def get_reviews(self, offset):
        ...
        # pane > div > div.Yr7JMd-pane-content.cYB2Ge-oHo7ed > div > div > div.siAUzd-neVct.section-scrollbox.cYB2Ge-oHo7ed.cYB2Ge-ti6hGc > div:nth-child(9) > div:nth-child(1) > div > div.ODSEW-ShBeI-content
    ...
    def __parse(self, review):
        ...
        id_review = review.find(
            'button', class_='ODSEW-ShBeI-JIbuQc-menu ODSEW-ShBeI-JIbuQc-menu-SfQLQb-title')['data-review-id']
        username = review.find(
            'div', class_='ODSEW-ShBeI-title').find('span').text

        try:
            review_text = self.__filter_string(review.find(
                'span', class_='ODSEW-ShBeI-text').text)
        except Exception as e:
            review_text = None

        rating = float(review.find(
            'span', class_='ODSEW-ShBeI-H1e3jb')['aria-label'].split(' ')[1])
        relative_date = review.find(
            'span', class_='ODSEW-ShBeI-RgZmSc-date').text
    ...
    def __expand_reviews(self):
        ...
        # pane > div > div.Yr7JMd-pane-content.cYB2Ge-oHo7ed > div > div > div.siAUzd-neVct.section-scrollbox.cYB2Ge-oHo7ed.cYB2Ge-ti6hGc > div:nth-child(9) > div:nth-child(184) > div > div.ODSEW-ShBeI-content > div:nth-child(3) > jsl > button
        links = self.driver.find_elements_by_css_selector(
            "div.ODSEW-ShBeI-RWgCYc jsl button")
        for l in links:
            l.click()
        time.sleep(2)
    ...
    def __scroll(self):
        ...
        # scrollable_div = self.driver.find_element(By.XPATH("//*[@id='pane']/div/div[1]"))
